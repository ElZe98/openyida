...
`openyida map` पेज, फॉर्म और प्रोसेस के बीच बिज़नेस संबंध व्यवस्थित करने के लिए है। सामान्य कमांड: `map rebuild`, `map show`, `map visualize`, `map link`, `map unlink`.
...
openyida map                  # बिज़नेस रिलेशन मैप प्रबंधित करें
